                ...
                width="560">
                    ...
                    <tr>
                        <td align="center" class="hero" style="background-color: #716aca;border-collapse: collapse; border-spacing: 0; margin: 0; padding: 10px 0;" valign="top">
                            ...
                            <h2 style="color:#fff;font-family:Helvetica;">BAE Portal Password Reset</h2>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        Silahkan klik link di bawah ini untuk mereset password Anda.</p>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table style="max-width: 240px; min-width: 120px; border-collapse: collapse; border-spacing: 0; padding: 0;" align="center" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td style="padding: 12px 24px; margin: 0; border-collapse: collapse; border-spacing: 0; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; -khtml-border-radius: 4px;" align="center" bgcolor="#716aca" valign="middle">
                                        <a target="_blank" style="font-weight:bold;color: #FFFFFF; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 120%;" href="{{ URL::to('resetpassword?verifier='.$password_reset_code) }}">
                                        Reset Password
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td style="text-align: center;">
                            <p style="margin-top: 30px">Jika tombol reset tidak bisa diklik, silahkan copy link berikut</p>
                            <p>{{ URL::to('resetpassword?verifier='.$password_reset_code) }}</p>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" class="paragraph" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 15px; padding-right: 15px; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%; padding-top: 15px; color: #202020; font-family: sans-serif;"
