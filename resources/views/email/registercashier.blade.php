        ...
        <tr>
            ...
            valign="top">
                ...
                width="560">
                    ...
                    <tr>
                        <td align="center" class="hero" style="background-color: #716aca;border-collapse: collapse; border-spacing: 0; margin: 0; padding: 10px 0;" valign="top">
                            <img src="http://trade2gov.com/front/images/t2g-mail.png" width="200px">
                            <h2 style="color:#fff;font-family:Helvetica;">Registrasi BAE Portal</h2>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        valign="top">
                        <div class="section-a" style="margin: 30px 0;">
                            <p>Anda telah terdaftar di Aplikasi BAE Portal. Berikut informasi email dan password untuk login:</p>
                            <table style="font-size:15px;background-color:#fafafa" cellpadding="8">
                              <tbody>
                                <tr style="background-color:#f4f4f4;border-bottom:1px solid #eeeeee">
                                  <td width="30%">Email</td>
                                  <td>:</td>
                                  <td>{{ $email }}</td>
                                </tr>
                                <tr valign="top" style="border-bottom:1px solid #eeeeee">
                                  <td>Password</td>
                                  <td>:</td>
                                  <td>{{ $password }}</td>
                                </tr>
                    ...
                    <tr>
                    <td style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;padding-top: 5px;padding-bottom: 5px;" class="button" align="center" valign="top">
                        <a href="https://trade2gov.com/login" target="_blank">
                            <table style="max-width: 240px; min-width: 120px; border-collapse: collapse; border-spacing: 0; padding: 0;" align="center" border="0" cellpadding="0" cellspacing="0">
                                <tbody>
                                <tr>
                                    <td style="padding: 12px 24px; margin: 0; border-collapse: collapse; border-spacing: 0; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; -khtml-border-radius: 4px;" align="center" bgcolor="#716aca" valign="middle">
                                        <a target="_blank" style="font-weight:bold;color: #FFFFFF; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 120%;" href="{{ URL::to('/login') }}">
                                        Login Sekarang
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td align="center" class="paragraph" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 15px; padding-right: 15px; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%; padding-top: 15px; color: #202020; font-family: sans-serif;"
                        valign="top">
                        <p style="margin: 30px 0;font-size:13px;">
                        Menerima email yang salah? Bila anda menerima email yang salah, mungkin ada pelanggan kami yang salah menginputkan alamat email. Bila anda menerima email ini karena kesalahan, mohon untuk menghapus email ini. Terima kasih.</p>
                        </td>
                    </tr>
                    ...
                    <tr >
                        <td align="center" class="list-item" style="font-family: sans-serif;border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 15px; padding-right: 15px; color: #555555" valign="top">
                            <h4 style="font-weight:bold;">PT. Electronic Data Interchange Indonesia</h4>
                                ...
                                Email: marketing@edi-indonesia.co.id<br>
                                private-sector@edi-indonesia.co.id</p>
                                </address>
                        </td>
                    </tr>
                    <!-- PARAGRAPH -->
                ...
                width="560">
                    ...
                    <tr>
                        ...
                        valign="top">
                            Copyright © 2016. PT. Electronic Data Interchange Indonesia.
                        </td>
                    </tr><!-- End of WRAPPER -->
